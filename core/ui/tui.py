...
_NAR_METHOD_PARAMS: dict[str, list[str]] = {
    ...
    "bm25-rag":  [],
    "specfi-cs": ["nar_generator", "nar_quantization", "nar_specfi_hypotheticals"],
    "specfi-ccs": ["nar_generator", "nar_quantization", "nar_specfi_hypotheticals"],
    "cspecfi":   ["nar_generator", "nar_quantization", "nar_specfi_hypotheticals"],
    "context-1": ["nar_generator", "nar_quantization",
...
_CAMP_METHOD_PARAMS: dict[str, list[str]] = {
    ...
    "bm25-rag":  [],
    "specfi-cs": ["camp_generator", "camp_quantization", "camp_specfi_hypotheticals"],
    "specfi-ccs": ["camp_generator", "camp_quantization", "camp_specfi_hypotheticals"],
    "cspecfi":   ["camp_generator", "camp_quantization", "camp_specfi_hypotheticals"],
    "context-1": ["camp_generator", "camp_quantization",
...
_VER_COMMON = [
    "ver_sources", "ver_generator", "ver_quantization",
...
_CANON_BENCH_DESC = (
    ...
    "Q4_K_M, Q6_K, Q8_0\n\n"
    "[dim]18 model × quant combinations.\n"
